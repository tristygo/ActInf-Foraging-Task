Active Inference Foraging Task with Comparison to a Marginal Value Theorem Agent.

How to run:
1.  Two packages need to be installed:
    pip install equinox
    pip install inferactively-pymdp

2.  Set T (travel time) and any other parameters desired, then run main.py
3.  Summary plots are generated at the end of the run.
